...
(see [sevostianovIJSS2007](@cite), [barthelemyIJES2019](@cite)) where `b = semi_minor`
...
Convention: same as the elastic [`compliance_contribution`](@ref MeanFieldHom.Core.compliance_contribution) — the
