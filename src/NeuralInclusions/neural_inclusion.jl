...
Neutral [`shape_trait`](@ref MeanFieldHom.Core.shape_trait) of the neural
...
[`fe_axi_localization`](@ref) takes.

Because [`is_homogeneous_inclusion`](@ref) is `false`, gate B costs **two**
