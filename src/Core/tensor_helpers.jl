...
"""
function _make_ortho(::Type{T},
                     C11, C22, C33, C12, C13, C23, C44, C55, C66,
                     _, basis::TensND.CanonicalBasis{3}) where {T}
    return TensND.TensOrtho(C11, C22, C33, C12, C13, C23, C44, C55, C66,
                            TensND.CanonicalBasis{3,T}())
end

function _make_ortho(::Type{T},
                     C11, C22, C33, C12, C13, C23, C44, C55, C66,
                     _, basis::TensND.RotatedBasis{3,T}) where {T}
