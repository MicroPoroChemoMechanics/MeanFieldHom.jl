...
function _hill_3d_aniso_residue(ell::Ellipsoid{3}, C₀;
                                 abstol::Float64 = 1e-8,
                                 reltol::Float64 = 1e-6,
    ...
    function hill_at_phi(φ::Float64)
        ...
        for I in 1:6
            ...
            for J in I:6
                vk, vl = voigt_ij[J]
                idx += 1
                p = (ζ_poly[vi] * (adj_poly[vj,vk]*ζ_poly[vl] + adj_poly[vj,vl]*ζ_poly[vk]) +
    ...
    P_vals, _ = QuadGK.quadgk(hill_at_phi, 0.0, π;
