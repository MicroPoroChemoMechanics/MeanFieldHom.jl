...
const E_ref = 210e3;  const ν_ref = 0.3
...
let
    ...
    grad_FD = fd_grad(f_abc, x₀; h=1e-4)
...
let
    ...
    dP11_dρ_FD = fd_deriv(f_ρ_11, ρ₀; h=1e-5)
    dP22_dρ_FD = fd_deriv(f_ρ_22, ρ₀; h=1e-5)
    ...
    dP_dk_FD = fd_deriv(f_k, k₀; h=1e-3)
