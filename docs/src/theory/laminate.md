...
no reference medium. Its effective behaviour is **exact and in closed form**,
...
[differential](@ref th-differential) scheme, …) describe *random*
...
``\mathbb{P}_i`` is the **Hill polarisation tensor of a flat inclusion**: the
...
[Hill tensors](@ref th-hill)). Having minor and major symmetries, it operates
...
- ``\mathbb{P}_i`` is the flat limit of the [Hill tensor](@ref th-hill): a
