...
[`scripts/28_multiscale_strength.jl`](https://github.com/jfbarthelemy/MeanFieldHom.jl/blob/main/scripts/28_multiscale_strength.jl)
...
- **TI symmetrize on non-coaxial inclusions** routes the matrix used for
  ...
  in [`src/Schemes/symmetrize.jl`](https://github.com/jfbarthelemy/MeanFieldHom.jl/blob/main/src/Schemes/symmetrize.jl).

## Validation

The package ships a cross-cutting test in
[`test/Schemes/test_sensitivities.jl`](https://github.com/jfbarthelemy/MeanFieldHom.jl/blob/main/test/Schemes/test_sensitivities.jl)
